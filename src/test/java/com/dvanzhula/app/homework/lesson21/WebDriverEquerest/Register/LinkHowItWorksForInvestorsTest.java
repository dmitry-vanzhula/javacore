 ...
 */
public class LinkHowItWorksForInvestorsTest extends FirefoxWebDriver {

    By howItWorks = By.xpath(".//*[@id='registerBlock']/div/div[2]/span[2]/a");
    By bannerTitle = By.xpath(".//*[@id='banner']/div/div[1]/div/h1");
    String expectedUrl = "https://dev.equerest.com/register#/";
    String actualUrl = "";
    String expectedHeaderBannerTitle = "Инвестируйте в перспективные проекты";

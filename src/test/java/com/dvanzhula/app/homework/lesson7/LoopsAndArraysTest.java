...
public class LoopsAndArraysTest {
    ...
    @Test
    public void showAnArrayOfRandomNumbersAndCalculateHowManyEvenTest(){
        int expRes = 0;
        Assert.assertNotEquals(expRes,LoopsAndArrays.showAnArrayOfRandomNumbersAndCalculateHowManyEven(16,0,9));
    }
